...
| Module 4 update work | Batch 0 approved and pushed. Batch 1 replaces enhanced Screens 2–5 only: Module 3 bridge, practice journey/output, Everyday Rights Lens, and Jiru Amba workstream exploration/selection. Screens 6–15 remain unchanged. | `src/data/module4/module4EnhancedModel.ts`; `src/components/course/module4/*`; `src/components/course/Module4Renderer.tsx`; `src/App.tsx`; `tests/module4-batch1.test.mjs`; Batch 1 QA evidence | High | Additive hydration preserves historical completion and unrelated course state; enhanced answers are versioned under `module4Enhanced.batch1` | None; frozen launch, learner isolation, progress, completion, assessment, and certificate contracts remain behaviorally protected | Build, lint, full tests, migration/hydration, route/ID contract, validation, keyboard semantics, responsive/mobile, 200% equivalent reflow, visual QA | Batch 1 Screens 2–5 complete — awaiting review; no production deployment | Batch 1 handoff commit |
