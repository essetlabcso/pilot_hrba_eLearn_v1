...
export const MODULE3_REVISED_SCREENS: Module3RevisedScreen[] = [
  ...
  },
  {
    ...
    purpose: 'Review, save, and download the final HRBA Project Design Improvement Snapshot from actual saved Module 3 work.',
    phase: 'Part 7 of 7 · Check, save, and carry forward',
    eyebrow: 'MODULE 3 · PORTFOLIO SNAPSHOT',
    interactionType: 'portfolio',
    continueLabel: 'Continue to Module 3 Closure',
    nextId: 'M3-R22',
  },
  {
    id: 'M3-R22',
