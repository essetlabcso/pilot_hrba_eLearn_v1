...
export const MODULE3_REVISED_SCREENS: Module3RevisedScreen[] = [
  {
    ...
    purpose: 'Intro video placeholder that orients learners to applying HRBA before implementation begins.',
  ...
  },
  {
    ...
    purpose: 'Anchor-case introduction with a media placeholder and access to the full written case narrative.',
    phase: 'Part 1 of 7 · See the design problem',
  ...
  },
  {
    id: 'M3-R05',
    screenNumber: 5,
    title: 'Context and Inequality Analysis',
    ...
    continueLabel: 'Save learning and continue to standards and policy mapping',
    nextId: 'M3-R06',
  },
  {
    id: 'M3-R06',
  ...
  },
  {
    ...
    interactionType: 'builder',
    continueLabel: 'Save responsibility map and continue to power and influence analysis',
    nextId: 'M3-R09',
  },
  {
    id: 'M3-R09',
    screenNumber: 9,
    title: 'Power and Influence Analysis',
    purpose: 'Practice rating a small set of actors by decision power, current influence, lived knowledge, and likely change role.',
    phase: 'Part 4 of 7 · Clarify responsibility, power, and causes',
    eyebrow: 'MODULE 3 · POWER AND INFLUENCE',
    interactionType: 'builder',
    continueLabel: 'Save power map and continue to root causes and capacity gaps',
    nextId: 'M3-R10',
  },
  {
    id: 'M3-R10',
    ...
    continueLabel: 'Save learning and continue to gender and disability check',
    nextId: 'M3-R11',
  },
  {
    id: 'M3-R11',
    ...
    interactionType: 'classification',
    continueLabel: 'Save learning and continue to participation and accountability',
    nextId: 'M3-R12',
  },
  {
    id: 'M3-R12',
  ...
  },
  {
    ...
    interactionType: 'builder',
    continueLabel: 'Save learning and continue to repair activities',
    nextId: 'M3-R15',
  },
  {
    id: 'M3-R15',
    ...
    interactionType: 'builder',
    continueLabel: 'Save learning and continue to intervention logic',
    nextId: 'M3-R16',
  },
  {
    id: 'M3-R16',
    ...
    interactionType: 'builder',
    continueLabel: 'Save learning and continue to open the draft plan',
    nextId: 'M3-R17',
  },
  {
    id: 'M3-R17',
    ...
    interactionType: 'builder',
    continueLabel: 'Save plan review and continue to gap mapping',
    nextId: 'M3-R18',
  },
  {
    id: 'M3-R18',
    ...
    eyebrow: 'MODULE 3 · PROPOSAL REVIEW STUDIO',
    interactionType: 'builder',
    continueLabel: 'Save gap map and continue to repair',
    nextId: 'M3-R19',
  },
  {
    id: 'M3-R19',
    ...
    eyebrow: 'MODULE 3 · PROPOSAL REVIEW STUDIO',
    interactionType: 'builder',
    continueLabel: 'Save repair and continue to knowledge check',
    nextId: 'M3-R20',
  },
  {
    id: 'M3-R20',
