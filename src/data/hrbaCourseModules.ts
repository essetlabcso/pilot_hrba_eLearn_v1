...
export const HRBA_COURSE_MODULES: HRBAModuleDefinition[] = [
  ...
  },
  {
    ...
    description: 'Use safe evidence, feedback, indicators, stories, and reporting to support inclusion, learning, responsible adaptation, account-back, and honest claims. You will finish with a practical repair note and 90-day action bridge.',
    coverFocus: 'Practice using evidence to ask who was missed, what changed, what must be handled safely, and how to account back with a repair note and 90-day next step.',
