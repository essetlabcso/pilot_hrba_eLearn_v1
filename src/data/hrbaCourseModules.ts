...
export const HRBA_COURSE_MODULES: HRBAModuleDefinition[] = [
  {
    ...
    thumbnailSrc: '/assets/hrba/modules/module-1-cover.webp',
  ...
  },
  {
    ...
    thumbnailSrc: '/assets/hrba/modules/module-2-cover.webp',
  ...
  },
  {
    ...
    thumbnailSrc: '/assets/hrba/modules/module-3-cover.webp',
  ...
  },
  {
    ...
    duration: 'Approx. 75-90 min',
    thumbnailSrc: '/assets/hrba/modules/module-4-cover.webp',
  ...
  },
  {
    ...
    thumbnailSrc: '/assets/hrba/modules/module-5-cover.webp',
  ...
  },
  {
    ...
    description: 'Complete a 10-question HRBA judgment assessment after finishing the five course modules. A score of 80% or higher passes the assessment.',
