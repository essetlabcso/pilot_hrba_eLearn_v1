...
export const HRBA_COURSE_MODULES: HRBAModuleDefinition[] = [
  ...
  },
  {
    ...
    description: 'Use everyday CSO situations to identify rights, actors, participation, accountability, power, exclusion, and one safer improvement habit.',
    coverFocus: 'Rights, Actors, Principles, and Power in Everyday CSO Work',
    duration: 'Approx. 75-90 min',
    thumbnailSrc: '/assets/hrba/modules/module-2.png',
    thumbnailAlt: 'Module 2 cover image showing HRBA foundations: rights standards, actors, principles, power, participation, and accountability.',
