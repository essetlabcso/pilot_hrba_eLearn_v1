...
export const module2FinalScreens: Module2FinalScreen[] = [
  ...
  { id: '4.1', title: 'Seeing Power', purpose: 'Introduce visible, hidden, and invisible power.', kind: 'lesson-placeholder', route: '/module-2/screen-4-1' },
  ...
  { id: '5.3', title: 'Plain Language Standards', purpose: 'Use rights standards safely, constructively, and in plain language.', kind: 'lesson-placeholder', route: '/module-2/screen-5-3' },
