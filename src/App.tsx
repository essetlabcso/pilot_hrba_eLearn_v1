...
export default function App() {
  const [state, setState] = useState<LearningState>(() => {
    ...
    const module2RouteTargets: Record<string, { moduleId: string; screenId: string }> = {
      ...
      '/module-5/screen-5-15': { moduleId: 'module_05_hrba_meal', screenId: 'M5-R15' },
      ...
      '/module-5/screen-5-22': { moduleId: 'module_05_hrba_meal', screenId: 'M5-R15' },
      '/module-5/screen-5-23': { moduleId: 'module_05_hrba_meal', screenId: 'M5-R15' },
  ...
  const module5Sequence = [
    ...
    ...[
      ...
      ['M5-R02', 'What You Will Practice in This Module', 'Orient learners to the module purpose, CSO relevance, objectives, safe boundaries, and final output.'],
      ['M5-R03', 'What Is Missing from the Report?', 'Diagnose what a strong-looking activity report does not yet show.'],
      ['M5-R04', 'The HRBA MEAL Lens', 'Use five practical questions to read MEAL evidence through an HRBA lens.'],
      ['M5-R05', 'From Counting to Learning About Change', 'Practice moving from activity counts to evidence about access, barriers, change, and learning.'],
      ['M5-R06', 'Indicator Repair Lab', 'Repair weak output indicators into safer HRBA-informed indicators.'],
      ['M5-R07', 'Safe and Inclusive Evidence', 'Choose minimum necessary evidence that makes exclusion visible without exposing people.'],
      ['M5-R08', 'Feedback, Complaints, and Trust', 'Turn feedback collection into accountable response, referral, adaptation, and account-back.'],
      ['M5-R09', 'Ethical Stories and Responsible Data', 'Respond to risky story requests with consent, dignity, privacy, and truthful alternatives.'],
      ['M5-R10', 'Interpreting Evidence with Rights-Holders', 'Plan safe participatory interpretation without exposing sensitive details.'],
      ['M5-R11', 'Reading the Signals: When the Plan Should Change', 'Match evidence signals with responsible adaptation, referral, repair, or account-back actions.'],
      ['M5-R12', 'Reporting Without Losing the Rights Lens', 'Repair risky report claims into truthful, safe, rights-based reporting.'],
      ['M5-R13', 'Capstone: Evidence-to-Action Simulator', 'Synthesize the Module 5 cycle from evidence to safe action and account-back.'],
      ['M5-R14', 'My HRBA MEAL, Accountability, and Learning Repair Note', 'Create a safe structured repair note using choices only.'],
      ['M5-R15', '90-Day Practice Bridge and Account-Back Commitment', 'Choose a realistic next step and bridge from course learning to practice.'],
