...
Create a documentation-only Menu drawer behavior implementation specification before any Menu drawer ARIA, CSS, or broader state migration.
...
Slice 2 now verifies and independently evaluates:
...
The next safe task is documentation-only Menu drawer behavior implementation specification. It must not edit React, ARIA implementation, CSS, token files, routing, progress, assessment, certificate logic, accessibility toolbar behavior, assets, content, course screens, module CSS, or old HRBA files.
...
No CSS, token files, routing, progress, assessment, accessibility toolbar behavior, asset, content, or old course file should be changed during the next documentation-only Menu drawer behavior specification task.
