...
Create a documentation-only Menu drawer close affordance and focus destination decision before any Menu drawer behavior implementation, Menu launcher ARIA, CSS, or broader state migration.
...
Recommended next task: create a documentation-only Menu drawer close affordance and focus destination decision. Menu launcher ARIA remains separate. HelpOverlay remains deferred. Phase D CSS remains blocked.
...
No CSS, token files, routing, progress, assessment, accessibility toolbar behavior, asset, content, or old course file should be changed during the next documentation-only Menu drawer close affordance and focus destination decision task.
